...
@attr.s
class SetRadioStateMessage(Message):
    state = attr.ib()
...
@attr.s
class RadioState:
    is_playing = attr.ib(type=bool, converter=bool, default=False)
    station = attr.ib(type=int, default=-1)
...
class State:
    ...
    radio = attr.ib(type=RadioState, default=RadioState())
